...
All kext listed below can be found **pre-compiled** in the [Kext Repo](https://dortania.github.io/builds/). Kexts here are compiled each time there's a new commit.
